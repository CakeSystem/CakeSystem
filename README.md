...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&size=28&duration=3000&pause=1000&color=F76322&center=true&vCenter=true&width=435&lines=CakeSystem)](https://git.io/typing-svg)
...
[![CakeMinerSystem][CakeMinerSystem.io-badge]][CakeMinerSystem.io]
...
### 👉 **Linux安装**
   ...
   ```sh
     bash <(curl -s -L https://raw.githubusercontent.com/CakeSystem/CakeSystem/raw/main/install.sh)
   ```
